...
| 笔记 | 核心问题 |
|------|---------|
| [[11a - 系统提示词的组装流水线]] | 提示词由哪些段落组成？怎么排列？优先级如何决定？ |
| [[11b - 提示词缓存策略]] | 静态/动态怎么划分？全局缓存怎么工作？缓存失效怎么检测？ |
| [[11c - CLAUDE.md 配置层级]] | 多层配置文件怎么发现、加载、注入提示词？条件规则怎么匹配？ |
...
**相关笔记**：[[00 - Claude Code 架构总览]] | [[04 - 上下文与状态管理]] | [[06 - 扩展性机制]]
