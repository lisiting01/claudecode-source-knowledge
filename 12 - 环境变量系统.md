...
| 笔记 | 内容 |
|------|------|
| [[12a - 环境变量完整清单]] | 所有环境变量的分类速查表：变量名、用途、安全等级 |
| [[12b - 环境变量的安全过滤机制]] | 信任来源层级、三层过滤器链、子进程密钥清洗 |
...
> [!info] 深入了解
> 安全过滤的完整机制（信任来源层级、过滤器链、子进程清洗）见 [[12b - 环境变量的安全过滤机制]]。
...
识别之后，自动调整行为。比如检测到 GitHub Actions 就自动开启子进程密钥清洗（详见 [[12b - 环境变量的安全过滤机制#子进程的密钥清洗]]）。
...
- [[09 - 数据收集与隐私保护设计]] — 数据脱敏与隐私保护
- [[05 - 多智能体协作]] — 子代理的环境继承
- [[11c - CLAUDE.md 配置层级]] — 另一种配置层级系统
